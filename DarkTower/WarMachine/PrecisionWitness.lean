...
theorem weightedReference :
    variationalFreeEnergy precisionTwo
...
theorem swappedReference :
    variationalFreeEnergy precisionOne
...
theorem precisionAndErrorAreNotInterchangeable :
    variationalFreeEnergy precisionTwo (fun _ => 1) ≠
      variationalFreeEnergy precisionOne (fun _ => 2) := by

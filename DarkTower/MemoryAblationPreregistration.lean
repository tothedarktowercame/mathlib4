...
theorem regression_wrong_memory_is_typed_refusal :
  ...
  have h : validateErrors wrongMemoryTrace = [.wrongMemoryWithheld] := by decide
...
theorem regression_shared_session_is_typed_refusal :
  ...
  have h : validateErrors sharedSessionTrace = [.sharedSession] := by decide
...
theorem regression_post_solution_revision_is_typed_refusal :
  ...
  have h : validateErrors postSolutionTrace = [.wrongBaseRevision] := by decide
